  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z" fill="black"/>
    ...
    <!-- header end -->
        ...
        <main id="MainContent" class="content-for-layout">
                            ...
                            <div class="product-details ps-lg-4">
                                ...
                                <div class="product-accordion">
                                    <div class="product-accordion-item accordion-parent">
                                        <h4
                                            class="accordion-header d-flex align-items-center justify-content-between accordion-btn">
                                        ...
                                        <div class="accordion-content accordion-child">
                                            ...
                                            <ul class="mt-2 mb-0">
                                                <li>Apply a small amount of product on your skin in a discreet area,
                                                    such as the inside of your wrist or your inner arm.</li>
                                                <li>Wait 48 hours to see if there’s a reaction.</li>
                                                <li>Check the area at 96 hours after application to see if you have a
                                                    delayed reaction.</li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="accordion-content accordion-child">
                                            <div class="accordion-parent">
                                                ...
                                                <div
                                                    ...
                                                    <button
                                                        class="text_14 bg-transparent text-decoration-underline write-btn accordion-btn"
                                    ...
                                    <div class="product-accordion-item accordion-parent">
                                        ...
                                        <div class="accordion-content accordion-child">
                                            <p class="mb-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                Maiores molestiae dolorem facere nesciunt cupiditate rem est, hic, eum
                                                expedita nulla voluptate deleniti dolores quidem tenetur!</p>
                                        </div>
                                    </div>
                                    <div class="product-accordion-item accordion-parent">
                                        <h4
                                        ...
                                        <div class="accordion-content accordion-child">
                                            <p class="mb-0">Lorem ipsum dolor sit amet conse ctetur adipisicing elit,
            ...
            <div class="featured-collection-section mt-100 home-section overflow-hidden" data-aos="fade-up"
